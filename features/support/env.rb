...
#hash holding values for test servers (environments)
...
Before('@active')do
  ...
  #change 'user_name' and 'password' to credentials for remote server
  $gateway = Net::SSH::Gateway.new(
      server_ip, 'user_name', :password =>'password'
  )
  ...
  # substitute those values with your DB credentials and DB name
